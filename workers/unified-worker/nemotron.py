...
stream = False
query = "Translate the text, in this manga page to english, structure the output as list of tuples of (original text, translated text, confidence scores)"

kApiKey = "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"
