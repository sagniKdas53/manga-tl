...
def load_sample_meta(sample_dir):
    """Read examples/sampleN/meta.json, written by scripts/organize_examples.py from
...
def main():
    ...
    # examples/NSFW/) survived forever and made the corpus look larger than it was.
