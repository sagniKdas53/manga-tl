...
scripts/organize_examples.py from scripts/examples_manifest.json) — not from filename sniffing.
...
def load_sample_meta(sample_dir):
    """Read corpus/samples/sampleN/meta.json, written by scripts/organize_examples.py from
...
def main():
    ...
    for d in sample_dirs:
        ...
        if meta is None:
            skipped.append((sample_id, "no meta.json — run scripts/organize_examples.py first"))
            continue
        reference_file, reference_prov = pick_reference(meta)
