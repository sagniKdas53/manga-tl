...
corpus/scripts/flatten_samples.py from corpus/scripts/examples_manifest.json) — not from filename sniffing.
...
def load_sample_meta(sample_dir):
    """Read corpus/samples/sampleN/meta.json, written by corpus/scripts/flatten_samples.py from
    corpus/scripts/examples_manifest.json. Replaces the old filename-sniffing heuristics, which
...
def main():
    ...
    for d in sample_dirs:
        ...
        if meta is None:
            skipped.append((sample_id, "no meta.json — run corpus/scripts/flatten_samples.py first"))
            continue
        reference_file, reference_prov = pick_reference(meta)
