...
export const ColorPicker: React.FC<ColorPickerProps> = ({
  ...
  const handleSvMouseDown = (e: React.MouseEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement>) => {
  ...
  const PRESETS = [
    ...(allowTransparent ? [{ label: 'Ø', value: '', color: 'transparent', title: 'Transparent' }] : []),
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', position: 'relative' }}>
      <label style={{ fontSize: '11px', fontWeight: 'bold', color: 'var(--text-muted)' }}>{label}</label>
      <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
        ...
        <button
          ...
          style={{
            ...
            position: 'relative',
            overflow: 'hidden',
            backgroundImage: normalizedValue === 'transparent' || normalizedValue === '' 
          ...
          >
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginTop: '4px' }}>
              {PRESETS.map((p, idx) => (
                ...
                >
                  {p.color === 'transparent' && (
                    <div style={{ width: '100%', height: '1.5px', backgroundColor: '#ef4444', transform: 'rotate(45deg)' }} />
                  )}
                </button>
              ))}
            </div>
