    ...
    <div className="dashboard-content">
      ...
      {dragCounter > 0 && (
        <div style={{
          ...
          <div style={{
            background: 'linear-gradient(145deg, rgba(30,30,50,0.95) 0%, rgba(20,20,38,0.95) 100%)',
            border: '1px solid rgba(255,255,255,0.1)',
            borderRadius: '20px',
            ...
            <h2 style={{ color: '#fff', fontSize: '20px', fontWeight: 700, margin: 0 }}>Drop Manga Pages Anywhere</h2>
            <p style={{ color: 'rgba(226,232,240,0.7)', fontSize: '14px', margin: 0 }}>Release to add multiple files to Chapter {selectedChapter.chapterNumber}</p>
          </div>
        </div>
      )}
      ...
      {showEditModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div className="glass" style={{ padding: '32px', width: '100%', maxWidth: '400px' }}>
            <h2 style={{ fontFamily: 'var(--font-display)', marginBottom: '24px' }}>Edit Chapter</h2>
