          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, pt: 1 }}>
            <Box>
              ...
              <Box sx={{ display: 'flex', gap: 2, flexDirection: { xs: 'column', sm: 'row' } }}>
                ...
                <FormControl fullWidth size="small" disabled={settings.ocrProvider === "local"}>
                  ...
                  >
                    {settings.ocrProvider === "local" ? (
                      ...
                      [
                        <MenuItem key="default" value="">-- Default / Inherit Env --</MenuItem>,
                  ...
                  <FormHelperText>
                    {settings.ocrProvider === "local" ? "Using local OCR worker" : "Select vision-language model"}
                  </FormHelperText>
                </FormControl>
              </Box>
            </Box>
            ...
            <Box>
              ...
              <Box sx={{ display: 'flex', gap: 2, flexDirection: { xs: 'column', sm: 'row' }, mt: 2 }}>
                <FormControl fullWidth size="small" disabled={settings.qaMode === "vlm" || settings.qaMode === "none"}>
                ...
                <FormControl fullWidth size="small" disabled={settings.qaMode === "llm" || settings.qaMode === "none"}>
