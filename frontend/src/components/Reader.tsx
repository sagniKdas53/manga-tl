  ...
  const handleChangePageNumber = React.useCallback(async (pageId: string, newNumber: number) => {
    try {
      ...
      if (selectedPage?.id === pageId) {
        // Because fetchPages finishes, `pages` might not be instantly available in this closure with the new list,
        // but we can compute the new page index based on the fact that newNumber is the target.
        // Actually, just navigating to the page ID is safer.
        navigate(
