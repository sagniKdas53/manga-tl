...
public interface PageRepository extends JpaRepository<Page, UUID> {
  ...
  @org.springframework.data.jpa.repository.Query(
      "SELECT c.series.id, p.image.id, p.image.thumbnailStoragePath "
  ...
  @org.springframework.data.jpa.repository.Query(
      "SELECT p.chapter.id, p.image.id, p.image.thumbnailStoragePath FROM Page p WHERE p.chapter.series.id = :seriesId "
