...
| C02 (`ACTIVE`; [checkpoint](quality-checkpoints/C02.md)) | C01 | The transaction primitive, layer APIs and logical scene API are complete: [C02-R1](quality-checkpoints/C02-R1.md), [C02-R2](quality-checkpoints/C02-R2.md), [C02-R3](quality-checkpoints/C02-R3.md). Version-1 browser archives round-trip while missing/unsupported versions reject: [C02-R4a](quality-checkpoints/C02-R4a.md). C02-R4 transactional replacement and C02-R5 geometry invalidation remain. | Text, transform, cleanup, visibility, order and render-setting edits each invalidate output. No edit commits without its revision increment. |
