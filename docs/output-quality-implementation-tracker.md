...
| C02 (`ACTIVE`; [checkpoint](quality-checkpoints/C02.md)) | C01 | [C02-R1](quality-checkpoints/C02-R1.md) through [C02-R4](quality-checkpoints/C02-R4.md) are DONE. Current browser projects are versioned and reject unsupported imports: [C02-R4a](quality-checkpoints/C02-R4a.md). C02-R5 global geometry invalidation remains. | Text, transform, cleanup, visibility, order and render-setting edits each invalidate output. No edit commits without its revision increment. |
