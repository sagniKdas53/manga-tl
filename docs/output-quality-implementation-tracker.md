...
| UR02 — renderer capacity | DONE | At G4, before expanding typography in H03–H04 | **2026-09-15 user decision: approved capacity.** Accepted measured one-context amd64 configuration: 1 CPU, 2 GiB, `sample93` completes at 6764×4961 in 23.426/23.699 s cold/warm with 845 MiB sampled peak RSS; concurrent second job fails explicitly. Evidence: [G4](quality-checkpoints/G4.md), [E06](quality-checkpoints/E06.md), [capacity JSON](quality-runs/e06-20260915-renderer-capacity/evidence.json). This approval does not approve higher concurrency, silent downsampling, cleanup quality, typography completeness, corpus execution, or release. |
