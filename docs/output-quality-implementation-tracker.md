...
| [ ] | M2 — revision-safe output lifecycle | C01–C05 | G1 | G2 | **ACTIVE** — [C01](quality-checkpoints/C01.md), [C02](quality-checkpoints/C02.md), [C03](quality-checkpoints/C03.md) and [C04](quality-checkpoints/C04.md) are DONE; C05 remains |
