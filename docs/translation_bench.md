...
> **Source images.** Which file in `examples/sampleN/` is the source and which are references
> comes from that sample's `meta.json`, generated by `scripts/organize_examples.py` from the
...
```json
{
  "source_image": "examples/sample36/source/GhSomnxbIAEPKVw.jpg",
  "source_lang": "ja",
  "reference_image": "examples/sample36/reference/HPCfmSdXoAAbaPf.jpg",
