...
> **Archived — superseded.** [`../guides/run_ocr_bench.md`](../guides/run_ocr_bench.md) covers the
> same scope (OCR stage: local engines + VLM-as-OCR) and is the one
> [`../guides/benchmarks_guide.md`](../guides/benchmarks_guide.md) points at. Use that instead.
...
> multi-page via `scripts/corpus/`): [`translation_bench.md`](../guides/translation_bench.md) — methodology
