...
def test_length_ratio_translation():
    ...
    assert is_valid_translation("こんにちは", "This is a super long translation text that goes on and on and on and on and on and on and on and on and on and on and on and on and on.") is False
