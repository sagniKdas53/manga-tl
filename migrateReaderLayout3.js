...
// 4. Navbar replacement using string indices
...
code = code.replace(
  ...
  `      <ConfirmModal\n        isOpen={confirmModal.isOpen}` // Don't replace </div>, we replace it with `</Box>` right before InfoModal? No wait, original code:
);
// Actually, original code has:
//       <ConfirmModal ... />
//       <InfoModal ... />
//     </div>
//   );
// So replacing the very last `</div>` with `</Box>` is better.
code = code.replace(
  `      />\n    </div>\n  );\n};`,
  `      />\n    </Box>\n  );\n};`
);
